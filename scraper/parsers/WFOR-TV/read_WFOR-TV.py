...
manifest_file = "../../manifest_files/WFOR-TV.csv"
...
for row in reader:
    ...
    elif url_fixed.find(' BASEFILE') > 0 or url_fixed.find(' NAB') > 0 or url_fixed.find(' PIQ') > 0:
        nabs +=1
        this_file_types += 1
